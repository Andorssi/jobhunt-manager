            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody>
                {sortedApplications.map((app) => {
                  ...
                  return (
                    <tr key={app.id}>
                      <td className="border p-2 font-medium">{isEditing ? <input className="w-36 maxLength={50} rounded border p-1" value={app.companyName} onChange={(e) => updateApplication(app.id, "companyName", e.target.value)} /> : app.companyName}</td>
                      <td className="border p-2">{isEditing ? <input className="w-32 rounded border p-1" maxLength={50} value={app.mypageId} onChange={(e) => updateApplication(app.id, "mypageId", e.target.value)} /> : app.mypageId}</td>
                      ...
                      <td className="border p-2">{isEditing ? <input className="w-48 rounded border p-1" maxLength={100} value={app.url} onChange={(e) => updateApplication(app.id, "url", e.target.value)} /> : app.url ? <a className="text-blue-600 underline" href={app.url} target="_blank" rel="noreferrer">開く</a> : ""}</td>
                      <td className="border p-2">{isEditing ? <textarea className="w-48 rounded border p-1" maxLength={400} value={app.memo} onChange={(e) => updateApplication(app.id, "memo", e.target.value)} /> : app.memo}</td>
